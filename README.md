...
Main reference: [dos Santos, A.R., Nóbrega, M.F.,... Cope, J. M. Fish vulnerability to overfishing based on meta-analytical trait estimates: how alternative productivity assumptions influence risk assessment under a novel approach. Rev Fish Biol Fisheries 36, 68 (2026). https://doi.org/10.1007/s11160-026-10069-w](https://link.springer.com/article/10.1007/s11160-026-10069-w#citeas)

Base framework used in this PSA approach: [*Patrick, W. S., Spencer, P., Ormseth, O. A., Cope, J. M., Field, J. C., Kobayashi, D. R., ... & Lawson, A. (2009). Use of productivity and susceptibility indices to determine stock vulnerability, with example applications to six US fisheries*](https://media.fisheries.noaa.gov/dam-migration/ns1-patrick-et-al-2010.pdf) 
